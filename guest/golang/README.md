...
curl -Ls https://github.com/bytecodealliance/wasmtime/releases/download/v19.0.0/wasi_snapshot_preview1.reactor.wasm -o build/wasi_snapshot_preview1.reactor.wasm
